# Contributing to TyDeT Core Redis

We would love for you to contribute to TyDeT Core Redis and help make it even better than it is today! As a contributor, here are the guidelines we would like you to follow:

## Question or Problems

If you have a question about TyDeT Core Redis (not a bug report) please post it to [StackOverflow][stackoverflow] with the tag `tydet-core-redis`.
...
[stackoverflow]: https://stackoverflow.com/questions/tagged/tydet-core-redis
[github-repository]: https://github.com/Kabany/tydet-core-redis
[github-issue]: https://github.com/Kabany/tydet-core-redis/issues
[github-issue-new]: https://github.com/Kabany/tydet-core-redis/issues/new
[github-pull]: https://github.com/Kabany/tydet-core-redis/pulls
